...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ asset('/home') }}">SB Admin v2.0</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#"><i class="fa fa-asterisk fa-fw"></i> Section<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-section') }}">Edit Section</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-asterisk fa-fw"></i> About<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-about') }}">Edit About</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-asterisk fa-fw"></i> Skills<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-skill') }}">Add Skill</a>
                            </li>
                            <li>
                                <a href="{{ url('/manage-skill') }}">Manage Skill</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-portfolio') }}">Add Portfolio</a>
                            </li>
                            <li>
                                <a href="{{ url('/manage-portfolio') }}">Manage Portfolio</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-cc-discover fa-fw"></i> Services<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-service') }}">Add Service</a>
                            </li>
                            <li>
                                <a href="{{ url('/manage-service') }}">Manage Service</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            <li>
                                <a href="{{ url('/add-contact') }}">Edit Contact</a>
                            </li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
